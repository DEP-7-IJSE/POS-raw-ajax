...
var pagination_1 = require("./dto/pagination"); // const BASE_API = 'https://bc677221-4831-4411-b038-9e174414f8ff.mock.pstmn.io';
...
function loadAllCustomers() {
  ...
  http.open('GET', CUSTOMERS_SERVICE_API + ("?page=" + PAGINATION.selectedPage + "&size=" + PAGE_SIZE), true); // 4. Setting headers, etc.
...
},{"./dto/customer":"ts/dto/customer.ts","jquery":"node_modules/jquery/dist/jquery.js","./dto/pagination":"ts/dto/pagination.ts"}],"node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
